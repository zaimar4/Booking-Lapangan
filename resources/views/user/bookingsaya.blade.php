...
<div class="flex">
    ...
    <div class="flex-1 p-8 ml-64">
        ...
        <h1 class="text-2xl font-bold text-zinc-900 mb-1">Booking Saya</h1>
        <p class="text-zinc-500 text-sm mb-6">Pantau status booking lapangan kamu</p>
        ...
        @forelse($bookings as $booking)
            ...
            <div class="bg-white border border-zinc-200 rounded-xl mb-3 overflow-hidden">
                ...
                @if($booking->status === 'confirmed')
                    <div class="px-5 py-2 bg-blue-50 border-b border-blue-100 text-sm text-blue-700 font-medium flex items-center gap-2">
                ...
                <div class="flex items-center gap-4 p-4">
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex items-start justify-between gap-2">
                            <div>
                                <p class="font-semibold text-zinc-900">{{ $booking->lapangan->nama_lapangan }}</p>
                                <p class="text-xs text-zinc-400">{{ $booking->lapangan->jenisLapangan->nama_jenis ?? '-' }}</p>
                            </div>
                            <span class="text-xs font-medium px-2.5 py-1 rounded-full {{ $statusColor }} shrink-0">
                                {{ $statusLabel }}
                            </span>
                        </div>

                        <div class="flex flex-wrap gap-x-4 gap-y-1 mt-2 text-sm text-zinc-600">
                ...
                <div class="flex items-center justify-between px-4 py-2.5 bg-zinc-50 border-t border-zinc-100">
        ...
        @empty
            <div class="flex flex-col items-center justify-center py-16 bg-white border border-zinc-200 rounded-xl text-center">

...
<div class="p-4 sm:p-8">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-8">
        <div class="bg-white border border-zinc-200 rounded-xl px-4 sm:px-5 py-3 sm:py-4">
        ...
        <div class="bg-yellow-50 border border-yellow-100 rounded-xl px-4 sm:px-5 py-3 sm:py-4">
        ...
        <div class="bg-blue-50 border border-blue-100 rounded-xl px-4 sm:px-5 py-3 sm:py-4">
        ...
        <div class="bg-green-50 border border-green-100 rounded-xl px-4 sm:px-5 py-3 sm:py-4">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div class="lg:col-span-2 bg-white border border-zinc-200 rounded-xl overflow-hidden">
            <div class="flex items-center justify-between px-4 sm:px-5 py-3 sm:py-4 border-b border-zinc-100">
                <h2 class="font-semibold text-zinc-900 text-sm sm:text-base">Booking Terbaru</h2>
            ...
            @forelse($bookingTerbaru as $booking)
                ...
                @endphp
                <div class="flex items-center justify-between px-4 sm:px-5 py-3 sm:py-3.5 border-b border-zinc-50 last:border-b-0 hover:bg-zinc-50 transition-colors">
                    <div class="min-w-0 flex-1 mr-3">
                        <p class="text-sm font-medium text-zinc-900 truncate">{{ $booking->lapangan->nama_lapangan }}</p>
                    ...
                    <span class="text-xs font-medium px-2.5 py-1 rounded-full shrink-0 {{ $statusColor }}">
                        {{ $statusLabel }}
                    </span>
                </div>
            @empty
        ...
        <div class="flex flex-col gap-4">
            <div class="bg-white border border-zinc-200 rounded-xl p-4 sm:p-5">
                <h2 class="font-semibold text-zinc-900 mb-4 text-sm sm:text-base">Menu Cepat</h2>
            ...
            @if($totalConfirmed > 0)
                <div class="bg-blue-50 border border-blue-100 rounded-xl p-4 sm:p-5">

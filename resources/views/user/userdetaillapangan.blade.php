        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 flex flex-col gap-6">
                <div class="bg-white rounded-2xl overflow-hidden border border-gray-100">
                    ...
                    @else
                        <div class="w-full h-96 bg-gray-100 flex flex-col items-center justify-center text-gray-400">
                ...
                <div class="bg-white rounded-2xl p-6 border border-gray-100">
                    <h2 class="text-lg font-bold text-gray-900 mb-3">Deskripsi Lapangan</h2>
            ...
            <div>
                <div class="bg-white rounded-2xl p-6 border border-gray-100 sticky top-8">
                    ...
                    <div class="space-y-3 py-5 border-y border-gray-100 mb-5">
                    ...
                    <button class="w-full bg-green-500 hover:bg-green-600 text-white font-bold py-3 rounded-xl transition-all active:scale-[0.98] text-sm">
                        Booking Sekarang
                    </button>

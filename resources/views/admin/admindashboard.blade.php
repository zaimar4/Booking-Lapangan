...
<div class="p-6 ml-60">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-500 mt-1">Statistik booking dan pendapatan lapangan</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
        ...
        <div class="bg-white rounded-2xl shadow-md p-5 border">
            ...
            <h2 class="text-4xl font-bold text-green-600 mt-3">{{ $totalLapangan }}</h2>
        </div>

        <div class="bg-white rounded-2xl shadow-md p-5 border">
            <p class="text-gray-500 text-sm">Total Booking</p>
            <h2 class="text-4xl font-bold text-blue-600 mt-3">{{ $totalBookingSemua }}</h2>
        </div>

        <div class="bg-white rounded-2xl shadow-md p-5 border">
            <p class="text-gray-500 text-sm">Booking Pending</p>
            <h2 class="text-4xl font-bold text-yellow-500 mt-3">{{ $bookingPending }}</h2>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-white rounded-2xl shadow-md p-5 border">
            <h2 class="text-lg font-semibold text-gray-700 mb-5">Grafik Total Booking</h2>
            {!! $bookingChart->container() !!}
        </div>

        <div class="bg-white rounded-2xl shadow-md p-5 border">
            <h2 class="text-lg font-semibold text-gray-700 mb-5">Grafik Pendapatan</h2>
    ...
    <div class="bg-white shadow-md rounded-2xl overflow-hidden border">
        ...
        <div class="p-5 border-b">
            <h2 class="text-lg font-semibold text-gray-700">Booking Masuk</h2>
        </div>

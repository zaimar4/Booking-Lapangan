  ...
  <div class="h-full px-3 py-4 overflow-y-auto border-r border-zinc-200 bg-white flex flex-col">
      ...
      <ul class="space-y-2 font-medium flex-1">
        ...
        <li class="{{ request()->routeIs('admin.dashboard') ? 'bg-zinc-800 rounded-lg text-white' : 'text-zinc-500' }}">
          <a href="{{ route('admin.dashboard') }}"
            class="flex items-center px-3 py-2 rounded-lg group hover:bg-zinc-100 hover:text-zinc-900 transition-colors">
        ...
        <li>
          <a href="{{ route('admin.daftar-booking') }}"
            ...
            <svg class="shrink-0 w-5 h-5 transition duration-75 text-zinc-400 group-hover:text-zinc-900"
            ...
            <span class="flex-1 ms-3 whitespace-nowrap">Daftar Booking
              <span
                class="inline-flex items-center justify-center w-5 h-5 ms-10 text-xs font-bold text-white bg-zinc-900 rounded-full mr-5">
        ...
        <li
          class="{{ request()->routeIs('admin.semua-lapangan') ? 'bg-zinc-800 rounded-lg text-white' : 'text-zinc-500' }}">
        ...
        <p class="px-3 py-2 text-xs font-semibold text-zinc-400 uppercase tracking-wider mt-4">Kelola Laporan</p>

        <li>
          <a href="{{ route('admin.laporan.pendapatan') }}" class="flex items-center px-3 py-2 text-zinc-600 rounded-lg hover:bg-zinc-100 hover:text-zinc-900 transition-colors group">
            ...
            <span class="flex-1 ms-3 whitespace-nowrap">Laporan Bulanan
      ...
      <ul class="space-y-2 font-medium flex-1">
        ...
        <li>
          <a href="{{ route('user.cari-lapangan') }}"
            class="flex items-center px-3 py-2 text-zinc-600 rounded-lg hover:bg-zinc-100 hover:text-zinc-900 transition-colors group">
            <svg class="w-5 h-5 text-zinc-400 group-hover:text-zinc-900" xmlns="http://www.w3.org/2000/svg" fill="none"
    ...
    <div class="mt-auto pt-4">
      <a href="{{ route('logout') }}"
        ...
        <svg class="shrink-0 w-5 h-5 text-zinc-400 group-hover:text-zinc-900" aria-hidden="true"

      ...
      <ul class="space-y-2 font-medium flex-1">
        ...
        <li>
          <a href="{{ route('admin.laporan.pendapatan') }}"
            class="flex items-center px-3 py-2 text-zinc-600 rounded-lg hover:bg-zinc-100 hover:text-zinc-900 transition-colors group">
            <svg class="shrink-0 w-5 h-5 text-zinc-400 group-hover:text-zinc-900" xmlns="http://www.w3.org/2000/svg"
              fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
            <span class="flex-1 ms-3 whitespace-nowrap">Laporan Pendapatan</span>
          </a>
        </li>
